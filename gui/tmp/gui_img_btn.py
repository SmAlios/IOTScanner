...
class GUI:
    ...
    def create_commands_frame(self):
        ...
        img_home = Image.open("gui/logos/home.png")
        img_ble = Image.open("gui/logos/bluetooth.png")
        img_zigbee = Image.open("gui/logos/zigbee.png")

        img_home = ImageTk.PhotoImage(file=img_home)
        img_ble = ImageTk.PhotoImage(file=img_ble)
        img_zigbee = ImageTk.PhotoImage(file=img_zigbee)
        ...
        self.home_button.grid(row=0, column=0, sticky="n")

        self.ble_button = tk.Button(
            self.commands_frame,
            text="BLE",
            #font=("Arial", 12),
        ...
        self.ble_button.grid(row=1, column=0, sticky="n")

        self.zigbee_button = tk.Button(
            self.commands_frame,
            text="Zigbee",
            #font=("Arial", 12),
            #command=self.on_stop_click,
        ...
        self.zigbee_button.grid(row=2, column=0, sticky="n")

        self.home_button.img_home = img_home
        self.ble_button.img_ble = img_ble
        self.zigbee_button.img_zigbee = img_zigbee

        self.commands_frame.grid_columnconfigure(0, weight=1)
        self.commands_frame.grid_rowconfigure(0, weight=1)
        self.commands_frame.grid_rowconfigure(1, weight=1)
        self.commands_frame.grid_rowconfigure(2, weight=1)
